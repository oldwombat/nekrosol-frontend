      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
        ...
        <Pressable
          ...
          style={[
            buttons.secondary,
            {
              backgroundColor: showLog ? palette.link : palette.background,
          ...
          {visibleMessages.map((msg) => {
            ...
            return (
              <Pressable
                ...
                style={{
                  borderWidth: 1,
                  borderColor: isLog ? (accentColor ?? palette.tabIconDefault) : (msg.isRead ? palette.tabIconDefault : palette.link),
                  borderRadius: 10,
                  padding: isLog ? 10 : 14,
                  backgroundColor: palette.background,
                  gap: 4,
                  opacity: isLog ? 0.7 : (msg.isRead ? 0.75 : 1),
                }}
              >
                ...
                <Text style={[base.comments, { color: isLog ? palette.icon : palette.text, fontStyle: 'normal' }]}>
                  {msg.body}
                </Text>
              </Pressable>
            );
